...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.window.rootViewController = [[XKUINavigationController alloc] initWithRootViewController:[[NSClassFromString(@"XKMyDiaryController") alloc] init]];
...
- (void)imageViewAnimation {
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage getLaunchImage]];
